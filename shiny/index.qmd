...
:::{.callout-note}
Last updated to include games through: `September 4, 2022`.
:::
...
main <-
  main %>% inner_join(team_info, by = c("pos_team.x" = "school"))
...
-   `Clutch`: defined as any field goal attempt in the 4th quarter or overtime with under two minutes remaining that could tie the game or take the lead.
